\section{Diskreter Logarithmus}\label{Kapitel Diskreter Logarithmus}
	...
	\subsection{Baby-Step-Giant-Step-Algorithmus}\label{Kapitel Baby Step Giant Step Algorithmus}
		...
		\subsubsection{Baby-Step-Giant-Step Vorgehen}
			Zuerst wählt man t \myin \myMenge{N}, sodass $t \geq \sqrt[]{p-1}$ ist. Nun werden alle Baby-Steps benötigt, diese werden mit Gleichung \myRefGleichung{Gleichung Baby steps} ermittelt:
			\begin{equation}
	...
	\subsection{Index-Calculus-Algorithmus}
		...
		Die Grundidee beim Index-Calculus-Algorithmus ist, aus der Kenntnis des diskreten Logarithmus für einige Zahlen, kann über die passenden Gleichungen der diskrete Logarithmus von beliebigen Zahlen berechnet werden.\cite{DLP:ECDLP:Probleme:und:Loesungen} %TODO Komischer Satz
