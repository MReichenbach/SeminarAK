...
\begin{document}
	...
	\printbibliography[nottype=book, nottype=thesis, nottype=mvbook, nottype=booklet, nottype=unpublished, nottype=manual, nottype=article, nottype=online, nottype=misc, heading=subbibliography, title={Alles Andere}]
