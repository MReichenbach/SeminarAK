\section*{Grundlagen}\label{Kapitel Grundlagen}
	...
	\subsection*{Algebraische Strukturen}
		...
		\subsubsection*{Ringe}
			...
			\begin{itemize}
				\item (R, +) ist eine abelsche Gruppe. (Eine Operation \mycirc auf einer Menge M heißt kommutativ oder abelsch, wenn: a \mycirc b = b \mycirc a für alle a, b \myin M gilt.)
